    ...
    public class TestExecutor : ITestExecutor
    {
        ...
        public void RunTests(IEnumerable<TestCase> testsToRun, IRunContext runContext, IFrameworkHandle frameworkHandle)
        {
            ...
            foreach(var CatchExe in listOfExes)
            {
                ...
                ReportResults(output_text, tests.ToList(), frameworkHandle);
        ...
        protected virtual void ReportResults(IList<string> output_text, IList<TestCase> vsTests, IFrameworkHandle frameworkHandle)
        {
            this.frameworkHandle = frameworkHandle;
